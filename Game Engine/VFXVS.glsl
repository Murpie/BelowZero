...
void main()
{
	...
	vec3 vertexPosition_worldspace = particleCenter_worldspace + cameraRight_worldspace * squareVertices.x * particleSize + vec3(0, -0.8, 0) * squareVertices.y * particleSize;
